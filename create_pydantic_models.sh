...
datamodel-codegen --output-model-type pydantic_v2.BaseModel --snake-case-field --url "https://opendata-download-metanalys.smhi.se/api/category/mesan2g/version/2/geotype/multipoint/time/20260428T170000Z/parameter/air_temperature/data.json?with-geo=false&downsample=10" --class-name DataModel --output mesan_data_multipoint.py
