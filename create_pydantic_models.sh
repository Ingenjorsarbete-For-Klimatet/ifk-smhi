...
datamodel-codegen --output-model-type pydantic_v2.BaseModel --snake-case-field --url https://opendata-download-metanalys.smhi.se/api/category/mesan2g/version/2/parameter.json --class-name DataModel --output mesan_parameters.py
datamodel-codegen --output-model-type pydantic_v2.BaseModel --snake-case-field --url https://opendata-download-metanalys.smhi.se/api/category/mesan2g/version/2/createdtime.json --class-name DataModel --output mesan_approved.py
datamodel-codegen --output-model-type pydantic_v2.BaseModel --snake-case-field --url https://opendata-download-metanalys.smhi.se/api/category/mesan2g/version/2/times.json --class-name DataModel --output mesan_valid.py
datamodel-codegen --output-model-type pydantic_v2.BaseModel --snake-case-field --url https://opendata-download-metanalys.smhi.se/api/category/mesan2g/version/2/geotype/polygon.json --class-name DataModel --output mesan_polygon.py
datamodel-codegen --output-model-type pydantic_v2.BaseModel --snake-case-field --url https://opendata-download-metanalys.smhi.se/api/category/mesan2g/version/2/geotype/multipoint.json --class-name DataModel --output mesan_multipoint.py
datamodel-codegen --output-model-type pydantic_v2.BaseModel --snake-case-field --url https://opendata-download-metanalys.smhi.se/api/category/mesan2g/version/2/geotype/point/lon/16/lat/58/data.json --class-name DataModel --output mesan_data_point.py
datamodel-codegen --output-model-type pydantic_v2.BaseModel --snake-case-field --url "https://opendata-download-metanalys.smhi.se/api/category/mesan2g/version/2/geotype/multipoint/time/20250904T080000Z/parameter/air_temperature/data.json?with-geo=false&downsample=10" --class-name DataModel --output mesan_data_multipoint.py
